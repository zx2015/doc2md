# Doc2MD Superpowers Index

This directory contains design specifications, brainstorming outcomes, and system architecture definitions developed through the `superpowers` workflow.
